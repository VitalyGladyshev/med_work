...
def start(update, context):
    ...
    txt = 'Здравствуйте! Бот найдёт ответы в базе. Признаком вопроса является знак вопроса :)'
...
def help_command(update, context):
    ...
    txt = "Задайте вопрос и бот найдёт самые подходящие вопросы-ответы в базе. \
